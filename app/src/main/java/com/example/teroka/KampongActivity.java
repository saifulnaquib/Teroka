...
public class KampongActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kampong);
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(KampongActivity.this, PenangActivity.class);
        ...
        review.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(KampongActivity.this, ReviewActivity.class);
                startActivity(intent);
            }
        });

        postList = new ArrayList<>();
        postAdapter = new PostAdapter(KampongActivity.this, postList);
    ...
    private void readPosts() {
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(KampongActivity.this, error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
/*
